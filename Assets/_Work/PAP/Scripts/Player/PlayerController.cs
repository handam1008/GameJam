...
namespace _Work.PAP.Scripts.Player
{
    public class PlayerController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            playerInput.OnMovementInputEvent += HandleOnMove;
        }
        ...
        /// </summary>
        private void HandleOnMove(Vector2 movementInput)
        {
            ...
            memory.TryPickUp(new MoveStack(direction, AgentMovement, IconFor(direction)));
        }

        private Sprite IconFor(Vector2Int direction)
        {
            if (direction == Vector2Int.up) return upIcon;
            if (direction == Vector2Int.down) return downIcon;
            if (direction == Vector2Int.left) return leftIcon;
            if (direction == Vector2Int.right) return rightIcon;
            return null;
        }
    }
}